...
import {
    ...
    SiPostgresql,
    SiOpencv,
    SiLatex, SiRstudioide, SiIntellijidea, SiEclipseide, SiPycharm
} from 'react-icons/si';
  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "R", icon:   <SiRstudioide className="h-4 w-4" /> },,
        { name: "MATLAB", icon: <Code2 className="h-4 w-4" /> },
        { name: "LaTeX", icon: <SiLatex className="h-4 w-4" /> }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "IntelliJ", icon: <SiIntellijidea className="h-4 w-4" /> },
        { name: "PyCharm", icon: <SiPycharm className="h-4 w-4" /> },
        { name: "Eclipse", icon: <SiEclipseide className="h-4 w-4" /> },
        { name: "Visual Studio Code", icon: <Code2 className="h-4 w-4" /> },
        { name: "Google Cloud", icon: <SiGooglecloud className="h-4 w-4" /> },
        { name: "Azure", icon: <Cloud className="h-4 w-4" /> },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "YOLOv8", icon: <Code2 className="h-4 w-4" /> },
